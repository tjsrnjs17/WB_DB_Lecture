...
input: <input type = "text" name="content"/>//입력받은 text값을 content의 넣는다
input2: <input type = "text" name="content2"/>입력받은 text값을 content2의 넣는다
...
<?php
	$con = mysqli_connect("localhost", "root", "", "io");//db을 불러옴
